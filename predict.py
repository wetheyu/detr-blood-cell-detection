...
def get_args_parser():
    ...
    parser.add_argument('--num_classes', default=NUM_CLASSES, type=int,
                        help='number of object classes, excluding the no-object class')
...
def main(args):
    ...
    image_dir = Path(args.coco_path) / "val2017"
    image_file_path = os.listdir(image_dir)
    image_set = []

    for image_item in image_file_path:
        print("inference_image:", image_item)
        image_path = image_dir / image_item
